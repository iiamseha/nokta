...
```
Expo Go QR: [[expo start çalıştırınca çıkan QR kodunun linkini buraya yaz](https://expo.dev/accounts/cosefseha/projects/app/builds/e1b24aed-ed5d-48df-87bc-bf017463296e)]
```
